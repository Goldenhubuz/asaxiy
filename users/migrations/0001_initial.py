    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_address', models.CharField(blank=True, max_length=255, null=True)),
                ('gender', models.CharField(blank=True, choices=[('male', 'Мужской'), ('female', 'Женский')], default='male', max_length=10, null=True)),
                ('passport_series', models.PositiveSmallIntegerField(blank=True, null=True)),
